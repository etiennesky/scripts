...
#    fi
    if [ ! -f  $ofile_wgs ]; then 
        val_repl_csv.py -csv_file /data/docs/research/project/data/igbp-inland.csv -in_id IGBP_ID -out_id INLAND_ID  $options_gtiff -a_nodata $nodata  MCD12Q1.IGBP.SA.$year.wgs84.tif $ofile_wgs
